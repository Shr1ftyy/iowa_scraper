...
A Python script created to data mine quickstatsiowa
...
for team_link in range(link_num, len(team_links)):
	...
	game_stats = f'{SAVE_DIRECTORY}{table_title}.csv'
	print("Open")
	g = open(game_stats, "w")
	print("Write")
...
print(f"Team Game Schedule saved to the {SAVE_DIRECTORY} folder")
print("-----------------------------------------------------------------")
